...
class TriageAgent:
    ...
    def triage(self, email: Email, context: CalendarContext, past_emails: List[Email] | None = None) -> TriageResult:
        user_prompt = format_user_prompt(email, context, past_emails=past_emails or [])
